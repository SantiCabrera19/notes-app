...
function App() {
  ...
  }, [currentView, fetchActiveNotes, fetchArchivedNotes, fetchAllNotes]); // Dependemos de las funciones también

  // Cargar notas iniciales al montar el componente
  useEffect(() => {
    fetchActiveNotes();
  }, [fetchActiveNotes]); // Solo se ejecuta al montar
